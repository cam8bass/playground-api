      ...
      <form action="" @submit="onSubmit" class="form">
        <fieldset>
          ...
          <!-- <div class="form__errors">
            <span class="form__textError"
              >Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quasi nam alias, molestiae
              harum repellendus dicta modi error aliquam eligendi ullam inventore incidunt autem!
              Sequi delectus nam dolores, atque unde dicta.</span
            >
          </div> -->
        </fieldset>
      </form>
